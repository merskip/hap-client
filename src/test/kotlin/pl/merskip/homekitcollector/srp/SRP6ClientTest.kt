...
class SRP6ClientTest {
    ...
    @Test
    fun srp6client_checkCompabilityToHAPSpecificationNonCommercialVersion() {
        val srp = SRP6Client(
                "alice",
                "password123",
                fromHex("""BEB25379 D1A8581E B5A72767 3A2441EE"""), // salt
                fromHex("""40F57088 A482D4C7 733384FE 0D301FDD CA9080AD 7D4F6FDF 09A01006 C3CB6D56
                                ...
                                89CCA306 CC370A0B 18C8B886 E95DA0AF 5235FEF4 393020D2 B7F30569 04759042"""), // B public
                fromHex("""60975527 035CF2AD 1989806F 0407210B C81EDC04 E2762A56 AFD529DD DA2D4393""") // a private
        )
